                    ...
                    <div class="auth-inner py-2">
                        ...
                        <div class="card mb-0">
                            <div class="card-body">
                                ...
                                <h4 class="card-title mb-1 text-center">{{__('Select a payment method and proceed payment.')}}</h4>
                                    ...
                                    <div class="content-header" id="table-bordered">
                                        <div class="card">
                                            <div class="table-responsive">
                                                ...
                                                <a href="{{route('payment-details')}}" class="btn btn-primary w-100"
                                                   tabindex="4">{{__('Upload Transaction Proof')}}</a>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- Bordered table end -->
