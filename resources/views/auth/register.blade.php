                    ...
                    <div class="auth-inner py-2">
                        ...
                        <div class="card mb-0">
                            <div class="card-body">
                                ...
                                <h4 class="card-title mb-2">{{__('Enter details to register!')}} </h4>
                                <form class="auth-register-form mt-2" action="{{ route('register') }}" method="POST">
                                    ...
                                    <div class="mb-1">
                                        ...
                                        <input type="text" class="form-control @error('name')  is-invalid @enderror"
                                               ...
                                               name="name" aria-describedby="name" value="{{old('name')}}" tabindex="1"
                                               autofocus/>
                                        @error('name')
                                    ...
                                    <div class="mb-1">
                                        ...
                                        <div class="input-group">
                                            <input type="number"
                                                   ...
                                                   value="{{old('phone_no')}}" aria-describedby="phone_no" tabindex="2"
                                                   autofocus/>
                                            @error('phone_no')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                    ...
                                    <div class="mb-1">
                                        ...
                                        <div class="input-group input-group-merge form-password-toggle">
                                            ...
                                            <span class="input-group-text cursor-pointer eye-icon-se"
                                                  @error('password') style="border-color: #dc3545; " @enderror><i
                                                    data-feather="eye"></i></span>
                                        </div>
                                        @if ($errors->has('password'))
                                            <div style="color: #dc3545;">{{ $errors->first('password') }}</div>
                                        @endif
                                    </div>
