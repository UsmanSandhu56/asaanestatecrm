@section('title', 'Property Draft Edit')
            ...
            <section class="modern-horizontal-wizard">
                <div class="bs-stepper wizard-modern modern-wizard-example">
                    ...
                    <div class="bs-stepper-content">
                        <form wire:submit.prevent="store({{ $property->id }})" autocomplete="off">
                            @if ($currentStep === 1)
                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                @if ($currentStep == 1 || $currentStep == 2 || $currentStep == 3 || $currentStep == 4 || $currentStep == 5 )
                                    <button type="button" class="btn btn-md btn-primary" wire:click="editpropertydraft({{ $property->id }},{{$currentStep}})">
                                        {{__('Next')}}
                                    </button>
                                @endif
