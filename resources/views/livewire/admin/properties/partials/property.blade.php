<div wire:ignore.self id="account-details-modern"
    ...
    <div class="row">
        <div class="mb-1 col-md-6">
            ...
            <div class="btn-group w-100" role="group">
                ...
                <label class="btn btn-outline-primary waves-effect" for="btnradio1">{{__('Sale')}}</label>
            ...
            @if ($errors->has('purpose'))
                <div style="color: #dc3545;">{{ $errors->first('purpose') }}</div>
            @endif
        </div>
        <div class="mb-1 col-md-6">
            ...
            <div class="btn-group w-100" role="group2">
                @foreach ($categories as $category)
                    <input
                        wire:click="getSubcategories({{$category->id}})"
    ...
    <div class="row">
        <div class="mb-1 col-md-6">
            ...
            <input wire:model.defer="city"
                   type="text" id="city" autocomplete="off"
    ...
    <div class="row">
        <div class="mb-1 col-md-6">
            ...
            <input wire:model.defer="street_address" type="text" id="street_address"
            autocomplete="off"
