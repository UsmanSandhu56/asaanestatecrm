        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-start mb-0">{{__('Create Property')}}</h2>
            ...
            <section class="modern-horizontal-wizard">
                <div class="bs-stepper wizard-modern modern-wizard-example">
                    ...
                    <div class="bs-stepper-content">
                        ...
                        {{-- <form wire:submit.prevent="resetcategorys({{ $currentStep }})" autocomplete="off"> --}}
                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                @if ($currentStep == 6)
                                <button type="submit" name="step[1]" value="
                                complete" class="btn btn-md btn-primary">{{__('Submit')}}</button>
                   
                                @endif
                            </div>
                            {{-- @if ($currentStep == 1 || $currentStep == 2 || $currentStep == 3 || $currentStep == 4 || $currentStep == 5 )
                            <br>
                            <button type="submit"  wire:click="resetcategory()"  class="btn btn-md btn-primary" >
                                {{__('Save As Draft')}}
                            </button>
                            @endif --}}
                        </form>
