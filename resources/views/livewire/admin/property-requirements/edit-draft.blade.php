@section('title', 'Property Requirement Edit Draft')
            ...
            <section class="modern-horizontal-wizard">
                <div class="bs-stepper wizard-modern modern-wizard-example">
                    ...
                    <div class="bs-stepper-content">
                        <form wire:submit.prevent="store({{$propertyRequirement->id}})" autocomplete="off">
                            @if ($currentStep === 1)
                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                @if ($currentStep == 1 || $currentStep == 2 || $currentStep == 3)
                                    <button type="button" class="btn btn-md btn-primary" wire:click="editpropertyreqdraft({{$currentStep }}, {{$propertyRequirement->id }})">
                                        {{__('Next')}}
                                    </button>
                                @endif
