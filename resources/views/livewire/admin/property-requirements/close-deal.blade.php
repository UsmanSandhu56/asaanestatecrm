        ...
        <div class="content-body row">
            <div class="col-md-6 col-6 close-border">
                <h2 class="content-header-title mb-1 border-0 cl-deal-head position-relative"><i class="fa fa-star"></i>
                    {{__('Property Details')}} <a href="{{route('properties.create')}}" class="btn btn-primary"
                                                  target="_blank">+</a></h2>
        ...
        <div class="row">
            <div class="col-12 mt-3 mb-3">
                <h2 class="content-header-title mb-2 border-0"><i
                        class="fa fa-star"></i> {{__('Deal Details (Rent/Sale)')}}</h2>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6 col-12">
                                        <div class="mb-1">
                                            ...
                                            <input type="number" wire:model.defer="agency_commission"
                                                   wire:model="agent_commission" id="agency_commission"
